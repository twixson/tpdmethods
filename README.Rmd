...
```{r 'plot_2020', fig.height=3, fig.width=7}
library(tpdmethods)
...
I NEED TO MAKE A FUNCTION THAT RETURNS THE EIGENPLOTS THAT DAN HAS IN HIS FINANCIAL EXPLORATION. 
