...
distribution. This means that we will need to marginally transform the generated
seasons back to being marginally Fr\'echet(2). To do this we generate 1000 
seasons all at once and use the ECDF. 
...
It appears that the dependence may have been slightly stronger under the climate
